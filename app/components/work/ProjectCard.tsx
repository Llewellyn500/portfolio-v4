        ...
        >
            ...
            >
                <Image
                    ...
                    width={500}
                    height={500}
                    className={`absolute -bottom-2 w-[95%] sm:w-[95%] md:w-[75%] lg:max-w-[55%] ${
                    ...
                    {available ? (
                        <>
                            <Link
                                ...
                                className="rounded-full w-[60px] bg-white p-5 text-[20px] md:w-[65px] md:text-[24px] lg:w-[70px] lg:text-[28px]"
                                data-blobity
